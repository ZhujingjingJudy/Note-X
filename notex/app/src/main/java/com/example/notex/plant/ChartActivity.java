...
import com.example.notex.guide.DoodleGuideActivity;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.btn_select_image).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                photoSelectUtil.clooosePhoto(ChartActivity.this);
//                ImageSelectorActivity.startActivityForResult(REQ_CODE_SELECT_IMAGE, MainActivity.this, null, false);
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        String path1 = photoSelectUtil.getActivityResult(this, requestCode, resultCode, data);
        if(path1!=null){
            // 涂鸦参数
            DoodleParams params = new DoodleParams();
            params.mIsFullScreen = true;
            // 图片路径
            params.mImagePath = path1;
            // 初始画笔大小
            ...
            // 启动涂鸦页面
            DoodleActivity.startActivityForResult(ChartActivity.this, params, REQ_CODE_DOODLE);
        }
